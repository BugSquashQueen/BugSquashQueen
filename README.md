...
Currently improving in automation test engineering to test my hospitality QR-code web application -which is my first project- for my current hospitality based company and further projects </p> 



## Tech Stack --> to be continued 👋
